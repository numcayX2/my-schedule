      ...
      <div className="max-w-[1400px] mx-auto overflow-x-auto pb-8">
        <div className="min-w-[1100px] relative bg-[#121212] border border-[#222222] shadow-[8px_8px_0px_0px_rgba(255,92,0,0.05)]">
          ...
          <div className="grid grid-cols-[80px_repeat(10,1fr)] gap-[1px] bg-[#222222]">
            ...
            {/* Wednesday - Intentionally blank, handled by background grid */}
    ...
    >
      ...
      <div className="pl-2">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-[#ff5c00] text-[10px] font-black tracking-widest">{code}</span>
        </div>
        <div className="text-[13px] font-bold text-[#e0e0e0] leading-tight mb-2 pr-2">{name}</div>
        <div className="text-[11px] text-[#666666] font-medium tracking-wide flex items-center gap-1">
      ...
      <div className="absolute right-2 bottom-2 text-[#2a2a2a] text-[8px] font-bold tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
        // SYS.ACT
      </div>
    </div>
  );
